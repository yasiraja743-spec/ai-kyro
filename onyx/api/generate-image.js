...
export default async function handler(req,res){
  ...
  try{
    ...
    const upstream=await gatewayFetch('/v1/images/generations',{method:'POST',headers:{'Content-Type':'application/json','Accept':'application/json,image/*'},body:JSON.stringify(body)});
